export default function DashboardCards(props) {
  return (
    <div className=" w-full md:w-6/12  xl:w-4/12 px-3 xl:px-4 pt-6 md:pt-8">
      <div className="py-6 pl-6 rounded-3xl bg-white hover:shadow-[0_0_11px_rgba(33,33,33,.2)] transition-all ease-linear duration-300 xl:max-w-[341px] w-full max-h-[164px] h-full mx-auto md:mx-0">
        {props.dashboardcard}
