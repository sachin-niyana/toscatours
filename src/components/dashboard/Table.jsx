  ...
  return (
    <div className="bg-mist-gray py-10 px-5">
      <div className="rounded-3xl bg-white">
        <div className="pt-6">
          <nav className="flex px-4 md:px-6 lg:gap-3 md:gap-6 !gap-3 pb-6 lg:justify-between max-lg:gap-6 items-center">
            <div className="bg-mist-gray py-[11px] px-4 w-full flex gap-3 items-center rounded-3xl border-[.5px] border-neutral-gray">
              ...
              <input
                ...
                className="bg-mist-gray outline-0 w-full border-0 truncate"
              />
            </div>
          ...
          <div className="overflow-x-auto  w-full max-lg:pr-28">
            <table className="xl:w-full max-lg:w-[800px] max-min-w-[800px] lg:w-full">
              <thead>
                  ...
                  >
                    ...
                    <td className="text-base font-semibold flex items-center leading-6 text-light-black py-6">
                      <div className="flex items-center justify-between w-full max-w-[180px]">
                        ...
                        <span className="ml-[28px] flex items-center">
                          <Dots />
                        </span>
                      </div>
                    </td>
