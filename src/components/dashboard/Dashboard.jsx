        ...
        <div className="w-full 2xl:max-w-[1088px] mx-auto ">
          <div className="flex flex-row flex-wrap -mx-3 justify-center pb-6 md:pb-8">
            {DashboardCard.map((obj, index) => {
              const grademarkColor = index === 2 ? "#ff0000" : "#26A212";
              return (
                <DashboardCards
                  key={index}
          ...
          <div className="flex flex-row flex-wrap -mx-3 justify-center">
            <div className="lg:w-6/12 w-full px-3 xl:px-4 ">
              <div className="flex lg:block justify-center">
                <div className="py-6 px-4 xl:px-6 hover:shadow-xs transition-all ease-linear duration-300 bg-white rounded-3xl xl:max-w-[528px] min-h-[348px] w-full relative">
                  <div className="absolute w-[90.56px] h-[47.97px] bg-white rounded-sm shadow-xxs md:flex hidden justify-center items-center left top-[73.29px] 2xl:left-[218.18px] xl:left-[172.18px] lg:left-[99.18px] md:left-[204.18px] before:h before:w-0 before:z-[1] before:right-[-10px] before:top-[14.4px] before:absolute">
                    <div className="flex flex-col">
                      <p className="font-normal text-xs-10 text-dark-gray leading-normal capitalize pb-1">
                        Umsatz
                      </p>
                      <p className="text-black font-medium xl:text-sm text-xs leading-normal uppercase">
                        2 300 CHF
                      </p>
                    </div>
                  </div>
